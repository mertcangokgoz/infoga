...
class Banner:
	...
	def usage(self,_exit_=False):
		...
		print("Example:")
		print("\tinfoga --domain site.gov -v 3")
		print("\tinfoga --info admin@site.gov -v 3")
		print("\tinfoga --domain site.gov --source pgp --breach -v 1")
		print("\tinfoga --domain site.gov --source google --breach --report site_gov.txt -v 3\n")
		if _exit_: exit(0)